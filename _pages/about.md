...
**Data Augmentation using Generative Adversarial Networks (Aug. 2020 – Dec. 2020)**

- Implemented a Deep Convolutional Generative Adversarial Network (DCGAN) using dataset consisting of chest X-rays with the primary objective of creating similar images as those X-rays
- PyTorch was used to implement DCGAN and the model was trained on google colab. The final outcome images serve as a proof of concept that images generated by GANs could serve as additional data to train classification models so as to increase their accuracy
